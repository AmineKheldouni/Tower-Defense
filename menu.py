...
class Menu():
     #meme largeur que carte, hauteur de 150 fixe
	def __init__(self, joueur):
     #type_objet est soit "lieu de construction", soit "tour", soit "base"
     #Si type_objet="lieu de construction", objet est pris égal à None, sinon
     #c'est la Tour ou la Base correspondant
          self._hauteur = 150
		self._largeur = 1250
		self._nb_cases_h = 3
		self._nb_cases_l = 25
          ...
          #self._affichage=[[None for i in range(3)] for j in range(25)]
